...
MEDIA = [
    ...
    ("flag-vietnam",  "File:Flag of Vietnam.svg",   None, "Flag of Vietnam"),
    ("flag-australia", "File:Flag of Australia.svg", None, "Flag of Australia"),
    ("meeting-fm-2024",
     "File:Australia-Vietnam Foreign Minister's Meeting - 2024 - 000172763.jpg",
     1280, "Hero — the bilateral relationship"),
    ("meeting-fm-2024-b",
     "File:Australia-Vietnam Foreign Minister's Meeting - 2024 - 000172786.jpg",
     1280, "Introduction — diplomatic engagement"),
    ("asean-summit-2024", "File:ASEAN-Australia Summit 2024.jpg",
     1280, "Discussion — the summit that launched the A$2bn facility"),
    ("port-haiphong",
     "File:Container Ship at the Hai Phong International Container Terminal 01.jpg",
     1280, "Trade pillar — Vietnamese container throughput"),
    ("rmit-vietnam", "File:RMIT University Vietnam - Campus.JPG",
     1280, "People & labour pillar — Australian education in Vietnam"),
]
...
def main() -> int:
    ...
    info = commons_info([t for _, t, _, _ in MEDIA])

    credits, failures = [], []

    for slug, title, width, role in MEDIA:
        ii = info.get(title)
        if not ii:
        ...
        credits.append({
            "slug": slug, "file": dest.name, "role": role, "title": title,
